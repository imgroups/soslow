...
$(document).ready(function () {
    ...
    function c() {
        $("#feature_slider").addClass("disabled").append('<ul id="pagination" /><div class="container"><div class="col-lg-2"><a href="" id="slide-left" /></div><div class="col-lg-2 col-lg-offset-8"><a href="" id="slide-right" /></div>');
